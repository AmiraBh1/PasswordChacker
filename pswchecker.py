...
def check_common_password(password):        
    common_passwords = ["123456789","password","iloveyou","admin","Password123",
      "********","qwertyuiop","password123","passw0rd","Azertyuio" 
  ]
...
while True:
    ...
    if check_common_password(password):
        print("Your password is common. Please choose a stronger password.")
